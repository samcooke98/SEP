    ...
    render() {
        return (
            <section>
                ...
                <Input type='text' label='Enter old password' name='oldPassword' value={this.props.oldPassword} onChange={(val) => this.props.handleChange(val, "oldPassword")} />
                <Input type='text' label='Password' name='password' value={this.props.title} onChange={(val) => this.props.handleChange(val, "title")} />
                <Input type='text' label='Confirm Password' name='newPassword' value={this.props.title} onChange={(val) => this.props.handleChange(val, "newPassword")} />
