    ...
    Team.findById(teamID, (err, team) => {
        if (!team)
            ...
            for (var email of emails) {
                ...
                console.log(email);
                //TODO: Email<
                sendEmail(email, "You've been invited to join a team on TeamShare", `<a href='http://teamshare-herokuapp.com/invite/${link.urlID}'> Join the team here </a> or paste https://teamshare-sep.herokuapp.com/invite/${link.urlID}`, true);
